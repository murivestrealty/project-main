...
          <h2 className="text-4xl md:text-5xl font-serif font-light mb-8 text-amber-50">
            Your Next Strategic Move Begins Here
          </h2>
          <p className="text-xl font-light text-neutral-50/80 max-w-3xl mx-auto mb-12 leading-relaxed">
